...
const CustomPagination = ({ page, setPage, showItem, total, limit }) => {
    ...
    <div className="w-full h-fit flex flex-col md:flex-row mt-8 justify-center items-center md:justify-between gap-2 mb-4">
      ...
      <div className="flex flex-row gap-1">
        {page > 1 ? (
          <div
            onClick={previusPage}
            className="flex px-3 py-1 bg-white hover:bg-gray-100 cursor-pointer rounded-md border-[2px] duration-300 ease-in-out"
          >
            {"<"}
          </div>
        ) : undefined}
