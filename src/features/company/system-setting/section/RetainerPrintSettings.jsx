    ...
    <section id="retainer">
      <div className="flex flex-col bg-base-100 p-5 rounded-md drop-shadow">
        <div className="flex gap-2 justify-between items-center mb-4">
          <div>
            <h1 className="font-semibold">Retainer Print Settings</h1>
            <p className="text-xs">Edit your company retainer details</p>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-3 w-full mt-6">
          <div className="w-full flex-1 flex flex-col gap-3">
            ...
            <div className="flex flex-col w-full">
              <h1 className="font-medium">Retainer Logo</h1>
              <img
          ...
          <div className="w-full md:w-[60%] md:max-w-[60%] h-fit max-h-[800px] overflow-y-auto flex flex-col">
            <div className="flex gap-2 justify-between">
              <div className="form-control">
                <h1 className="font-medium text-3xl mb-4">Retainer</h1>
...
export default RetainerPrintSettings;
