        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-6">
          <label className="form-control gap-2">
            ...
            <input
              ...
              defaultValue={"USD"}
            />
            <span className="label-text-alt">Note: Add currency code as per three-letter ISO code.</span>
            <a className="label-text-alt text-green-500 underline" href="https://stripe.com/docs/currencies" target="_blank" rel="noopener noreferrer">you can find out here..</a>
          </label>
          <label className="form-control gap-2">
            <span className="label-text font-semibold required">Currency Symbol</span>
            <input
              type="text"
              className="input input-bordered"
              defaultValue={"$"}
