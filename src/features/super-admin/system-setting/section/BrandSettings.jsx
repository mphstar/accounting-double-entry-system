    ...
    <section id="brand">
      <div className="flex flex-col bg-base-100 p-5 rounded-md drop-shadow">
        ...
        <div className="flex flex-col w-full md:flex-row mt-6  gap-4">
          ...
          <label className="form-control gap-2 w-full" htmlFor="">
            <h1 className="label-text font-medium">Footer Text</h1>
            <input
              className="input input-bordered"
              defaultValue={"AccountGo SaaS"}
              type="text"
        ...
        <div className="flex flex-col w-full md:flex-row mt-6  gap-4">
          ...
          <label className="form-control gap-2 w-56" htmlFor="">
            <h1 className="label-text font-medium">Enable Landing Page</h1>
            <input
              className="toggle toggle-primary"
              defaultValue={"AccountGo SaaS"}
              defaultChecked
          ...
          <label className="form-control gap-2 w-56" htmlFor="">
            <h1 className="label-text font-medium">Enable Sign-Up Page</h1>
            <input
              className="toggle toggle-primary"
              defaultValue={"AccountGo SaaS"}
              type="checkbox"
          ...
          <label className="form-control gap-2 w-56" htmlFor="">
            <h1 className="label-text font-medium">Enable Email Verification</h1>
            <input
              className="toggle toggle-primary"
              defaultValue={"AccountGo SaaS"}
              type="checkbox"
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 items-center">
              <FiCreditCard /> Primary color settings
            </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 items-center">
              <BsWindowSidebar /> Sidebar settings
            </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 items-center">
              <IoSunnyOutline /> Layout settings
            </div>
            <label className="flex items-center gap-2" htmlFor="">
              <input
                type="checkbox"
